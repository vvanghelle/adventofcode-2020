...
import com.vg.adventofcode.year2020.enigmas.enigma4.PassportPolicy1;
import com.vg.adventofcode.year2020.enigmas.enigma4.PassportPolicy2;
...
public class Enigma4Test {
    ...
    @BeforeEach
    public void init() {
        day4 = new Enigma4(new PassportBuilder(), new PassportPolicy1(), new PassportPolicy2());
    }
